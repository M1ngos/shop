										...
										<div class="product-des">
											...
											<div class="short">
												...
												<div class="rating-main">
													...
													<a href="#" class="total-review">({{$product_detail['getReview']->count()}}) Análise</a>
                                                </div>
                                                @php 
													...
													<div class="tab-single review-panel">
														<div class="row">
															<div class="col-12">
																...
																You need to <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Conecte-se</a> OU <a style="color:blue" href="{{route('register.form')}}">Registro</a>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		<span>Based on {{$product_detail->getReview->count()}} Comentários</span>
																	</div>
