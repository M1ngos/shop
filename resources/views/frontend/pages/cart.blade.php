					...
					<div class="total-amount">
						<div class="row">
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									<form action="{{route('coupon-store')}}" method="POST">
											@csrf
											<input name="code" placeholder="Insira o seu cupom">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Subtotal do carrinho<span>${{number_format(Helper::totalCartPrice(),2)}}</span></li>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Você salva<span>${{number_format(Session::get('coupon')['value'],2)}}</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Você salva<span>${{number_format($total_amount,2)}}</span></li>
										@else
											<li class="last" id="order_total_price">Você salva<span>${{number_format($total_amount,2)}}</span></li>
										@endif
									</ul>
