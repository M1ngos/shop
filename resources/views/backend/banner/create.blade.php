...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('banner.store')}}">
        ...
        <input id="inputTitle" type="text" name="title" placeholder="Introduza Título "  value="{{old('title')}}" class="form-control">
        @error('title')
        ...
        <div class="form-group mb-3">
          <button type="reset" class="btn btn-warning">Redefinir</button>
