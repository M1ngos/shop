...
<div class="card">
    <h5 class="card-header">Editar postagem</h5>
    <div class="card-body">
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="inputPhoto" class="col-form-label">Logotipo <span class="text-danger">*</span></label>
...
<script>
    ...
    $(document).ready(function() {
      $('#quote').summernote({
        placeholder: "Escreva uma pequena citação.....",
          tabsize: 2,
          height: 100
      });
    });
